...
samples_allfastq=read.csv('/home2/s421955/cleaned_data/samples_TCGA.csv',stringsAsFactors = F)#test for sato and TCGA
...
save(all_mat,file='~/projects/retrovirus/data/raw_all_mat_TCGA.RData')
all_mat[]=normalize.quantiles(log(data.matrix(all_mat)+1))
ctrl_length=dim(ctrl_mat_ann)[1]
save(samples_allfastq,all_mat,ctrl_length,file='/home2/s421955/projects/retrovirus/data/all_mat_TCGA_noncb.RData')
...
save(all_mat_cb,ctrl_length,samples_allfastq,file='/home2/s421955/projects/retrovirus/data/all_mat_TCGA_cb.RData')
